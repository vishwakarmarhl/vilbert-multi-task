...
python webcam.py --config-file ../configs/e2e_faster_rcnn_R_50_FPN_1x.yaml --min-image-size 800 MODEL.DEVICE cpu MODEL.WEIGHT ../output/e2e_faster_rcnn_R_50_FPN_1x.pth
